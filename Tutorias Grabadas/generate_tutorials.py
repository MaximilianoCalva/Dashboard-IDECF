#!/usr/bin/env python3
"""
Script para generar archivos HTML de tutorías grabadas para IDECF
...
<script>
    // URL PROPORCIONADA POR EL USUARIO (Versión 4 - Cache Fix)
    const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbzE-dsS3EbQ74c0CwUmNjVGKTezSBbMiKB_WbHqBPiQdRQQuWt6aXYEVEAEOrdq5j9H/exec";
...
def generate_tutorial_files():
    ...
    print(f"\n🎉 Successfully generated 40 tutorial files for IDECF!")
    print(f"📁 DCF: 20 files (DCFG01-DCFG20)")
    print(f"📁 DTG: 20 files (DTGG01-DTGG20)")

if __name__ == "__main__":
    generate_tutorial_files()
